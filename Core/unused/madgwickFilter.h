...
#ifndef DELTA_T
    #define DELTA_T 0.035f // 100Hz sampling frequency
    // I CHANGED THE SAMPLING FREQUENCY - HL
#endif

#ifndef GYRO_MEAN_ERROR
    #define GYRO_MEAN_ERROR M_PI * (5.0f / 180.0f) // 5 deg/s gyroscope measurement error (in rad/s)  *from paper*
#endif
